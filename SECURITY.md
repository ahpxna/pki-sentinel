...
| `vault-seal` | Persistent local Vault used as a transit auto-unseal key holder | A demo stand-in for a cloud KMS/HSM; protect and back up `.data/vault-seal`. See [ADR-0002](docs/adr/0002-auto-unseal-tradeoffs.md). |
